# 💾 Backup & DR Studio
> Generate Velero Kubernetes backup policies, database snapshot automation, and disaster recovery restore runbooks.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/backup-dr/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/backup-dr/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-backup-dr.git
cd tp-backup-dr
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/backup-dr/) |
